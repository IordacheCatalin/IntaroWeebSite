<?php
   ...
   if(isset($_POST['send'])) 
   {
		...
		try {
			...
			// the message
			$msg = "Buna ziua,<br /><br />";
			$msg .= "A fost receptionata o petitie noua trimisa de pe site-ul axeria-iard.ro!<br /><br />";
			...
			$msg .= "<li>CNP: <strong>" . $_POST['your-cnp']."</strong></li>";
			$msg .= "<li>Adresa: <br /><strong>" . $_POST['your-address']."</strong></li>";
			...
			$mail->Subject = 'Petitie noua client Axeria';
			$mail->Body    = $msg;
			$mail->AltBody = $msg;
